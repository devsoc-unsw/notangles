...
const Privacy: FunctionComponent = () => (
  <div>
    ...
    <p>
      ...
      personally identifiable information submitted by, or otherwise obtained from,
      you in connection with the associated application (“Application”). The
      Application is provided by Notangles (and may be provided by Notangles on
      behalf of a Notangles licensor or partner (“Application Partner”). By using or
      otherwise accessing the Application, you acknowledge that you accept the
      practices and policies outlined in this Privacy Statement.
    </p>

    <h2>What personal information does Notangles collect?</h2>
    ...
    <p>
      ...
      account). The types of personal information collected may include your
      username, email address, profile picture, friends that are also using the
      Application, and any other information necessary for us to provide the
      Application services.
    </p>

    <h2>How does Notangles use the information it collects?</h2>
    <p>
      Notangles uses the information described in this Privacy Statement (i)
      internally, to analyze, develop and improve its products and services, and
      (ii) as set forth below in the “Will Notangles share any of the personal
      information it receives” section below.
    </p>

    <h2>Will Notangles share any of the personal information it receives?</h2>
    <p>
    ...
    <p>
      Protection of Notangles and Others: We may release personal information when
      we believe in good faith that release is necessary to comply with the law;
      enforce or apply our conditions of use and other agreements; or protect the
      rights, property, or safety of Notangles, our employees, our users, or others.
      This includes exchanging information with other companies and organizations
    ...
    <p>
      ...
      third party applications/websites are not under Notangles’s control, and such
      links do not constitute an endorsement by Notangles of those other
      ...
      Application are not covered by this Privacy Statement, and Notangles is not
    ...
    <p>
      Notangles allows you to access the following information about you for the
    ...
    <p>
      Notangles may amend this Privacy Statement from time to time. Use of
      information we collect now is subject to the Privacy Statement in effect at
      ...
      Site or sending you an email. Users are bound by any changes to the Privacy
      Statement when he or she uses or otherwise accesses the Application after such
