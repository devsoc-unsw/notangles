      ...
      <div className="flex w-5/6 h-4/5 p-[10px] space-x-3">
        ...
        <div className="p-[10px] hidden sm:flex">
          <p className="text-white">
            ...
            This website seeks to be a centralised platform for students looking for employment opportunities, but its
            information has not been officially endorsed by the University, Faculty, School, or the Computer Science and
            Engineering Society. You should confirm with the employer that any information received through this website
            is correct. <br />
            <br />
            Notangles was made with by CSE students for CSE students.
          </p>
        </div>
      </div>
    </div>
