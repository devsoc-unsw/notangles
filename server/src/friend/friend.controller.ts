...
export class FriendController {
  ...
  friendUsers(@Body() friendDto: friendDto) {
    return this.friendService.friendUsers(friendDto.senderId, friendDto.sendeeId);
  }

  @Delete()
  unfriendUsers(@Body() friendDTO: friendDto) {
    return this.friendService.unfriendUsers(friendDTO.senderId, friendDTO.sendeeId);
  }
  ...
  sendFriendRequest(@Body() friendDTO: friendDto) {
    return this.friendService.sendFriendRequest(friendDTO.senderId, friendDTO.sendeeId);
  }
